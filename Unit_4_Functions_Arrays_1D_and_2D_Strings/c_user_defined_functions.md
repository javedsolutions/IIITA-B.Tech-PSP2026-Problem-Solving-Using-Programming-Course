...
* ### Current Topic: User-Defined Functions in C
* **Purpose:** User-defined functions, function definition, prototype, parameter list, function arguments, and return types
---
